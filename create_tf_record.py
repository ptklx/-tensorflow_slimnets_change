...
def read_image(filename, resize_height, resize_width,normalization=False):
    ...
    if bgr_image is None:
        print('this picpath is NULL',filename)
        return None
...
if __name__ == '__main__':
    ...
    log=5
    # 产生train.record文件
    image_dir = '/datasdb/pengtao/X1/picdata/TrainCard0'
    train_labels = '/datasdb/pengtao/X1/picdata/train0.txt'
   
    if versionV1_V4 ==1:
        train_record_output = 'mjdataset/record/train.tfrecords'
    elif versionV1_V4 ==3:
        train_record_output = 'mjdataset/record/train299.tfrecords'
    ...
    # 产生val.record文件
    image_dir = '/datasdb/pengtao/X1/picdata/TrainCard0'
    val_labels = '/datasdb/pengtao/X1/picdata/val0.txt'  # 图片路径
    if versionV1_V4 ==1:
        val_record_output = 'mjdataset/record/val.tfrecords'
    elif versionV1_V4 ==3:
        val_record_output = 'mjdataset/record/val299.tfrecords'
